...
<script>
	...
	function order(){
    	...
    	if(ans){
			...
			//alert(document.getElementById("productIdx").value);
			//document.getElementById("productIdx").value = productIdx;
    		/* 
			document.getElementById("productName").value = productName;
			document.getElementById("mainPrice").value = mainPrice;
			document.getElementById("thumbImg").value = thumbImg;
			document.getElementById("optionName").value = optionName;
			document.getElementById("optionPrice").value = optionPrice;
			document.getElementById("optionNum").value = optionNum;
...
<div class="container">
	...
	<form name="myform" id="myform" method="post" action="${ctp}/shop/orderInput2">
		<div class="container mt-0 mb-0" style="background-color:white; margin-top:0px;">
			<table class="table table-borderless pt-3 mb-0" style="background-color:white; width:90%; font-family : 'pretendard'; margin:auto;">
				<tr style="border-bottom: 1px solid #D5D5D5;">
					<td colspan="2">
		...
		<input type="hidden" name="payment" id="payment"/>
	  	...
	  	<input type="hidden" name="mainPrice" id="mainPrice" value="${vo.mainPrice}"/>
	  	<input type="hidden" name="thumbImg" id="thumbImg" value="${vo.thumbImg}"/>
	  	<input type="hidden" name="optionName" id="optionName" value="${vo.optionName}"/>
	  	<input type="hidden" name="optionPrice" id="optionPrice" value="${vo.optionPrice}"/>
	  	<input type="hidden" name="optionNum" id="optionNum" value="${vo.optionNum}"/>
	  	<input type="hidden" name="totalPrice" id="totalPrice" value="${vo.totalPrice}"/>
	  	<input type="hidden" name="cartIdx" id="cartIdx" value="${vo.cartIdx}"/>
	  	<input type="hidden" name="saleRate" id="saleRate" value="${vo.saleRate}"/>
	  	<input type="hidden" name="costPrice" id="costPrice" value="${vo.costPrice}"/>
	</form>
</div>
